...
const meta: Meta<typeof SquircleButton> = {
  title: 'UI/Input/Button/SquircleButton',
  component: SquircleButton,
};

export default meta;
type Story = StoryObj<typeof SquircleButton>;
...
export const Catalog: CatalogStory<Story, typeof SquircleButton> = {
...
export const SoonCatalog: CatalogStory<Story, typeof SquircleButton> = {
...
export const PositionCatalog: CatalogStory<Story, typeof SquircleButton> = {
  args: { title: 'Filter', Icon: IconSearch },
  argTypes: {
    size: { control: false },
    variant: { control: false },
